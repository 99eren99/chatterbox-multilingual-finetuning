...
Use the provided finetuning scripts to finetune chatterbox multilingual t3 and s3/flow model.<br>
reference: https://github.com/stlohrey/chatterbox-finetuning
...
```
#set language in finetune_t3.py at line 86
